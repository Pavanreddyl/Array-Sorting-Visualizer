...
function disableSortingBtn() {
    ...
    document.getElementsByClassName("bubbleSort")[0].style.display = 'none';
    document.getElementsByClassName("insertionSort")[0].style.display = 'none';
    document.getElementsByClassName("mergeSort")[0].style.display = 'none';
    document.getElementsByClassName("quickSort")[0].style.display = 'none';
    document.getElementsByClassName("selectionSort")[0].style.display = 'none';
    document.getElementsByClassName("heapSort")[0].style.display = 'none';
...
function enableSortingBtn() {
    ...
    document.getElementsByClassName("bubbleSort")[0].style.display = 'inline';
    document.getElementsByClassName("insertionSort")[0].style.display = 'inline';
    document.getElementsByClassName("mergeSort")[0].style.display = 'inline';
    document.getElementsByClassName("quickSort")[0].style.display = 'inline';
    document.getElementsByClassName("selectionSort")[0].style.display = 'inline';
    document.getElementsByClassName("heapSort")[0].style.display = 'inline';
}
